...
# There are also two buttons that say "Accept" and "Deny" that change the value of the equipment to whether it is accepted or not (true or false).
    ...
    <table>
        <tr>
            <td>
                <form action="../" method="POST"><input type=hidden value=<?php echo $id; ?> id=rid name=rid><input
                        type=hidden value=1 id=accept name=accept><input type=submit value=Accept></form>
            </td>
            <td>
                <form action="../" method="POST"><input type=hidden value=<?php echo $id; ?> id=rid name=rid><input
                        type=hidden value=0 id=accept name=accept><input type=submit value=Deny></form>
            </td>
        </tr>
    </table>
</body>